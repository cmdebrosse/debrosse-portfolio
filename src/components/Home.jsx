    ...
    <div name="home" className="w-full h-screen bg-slate-800">
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <p className="text-slate-100 py-4 max-w-[700px]">
          After years in the CNC Machining industry I'm making my way into the
          world of web development. Having successfully completed a full-stack
          bootcamp through the Ohio State University, I'm ready to face the
          excitement and challenges this burgeoning domain has to offer!
        </p>
        <div>
